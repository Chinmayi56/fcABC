...
class OrderItemOut(BaseModel): id:uuid.UUID; product_id:uuid.UUID; product_name:str; sku:str; quantity:int; unit_price:Decimal|None=None; subtotal:Decimal|None=None; configuration:str|None=None
